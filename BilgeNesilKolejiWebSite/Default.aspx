<%@ Page Title="Bilge Nesil Koleji | ÖZGÜN ve TEMATİK OKULCULUK" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="wow animated" style="visibility: visible;">
        <div class="container mb-20">
            <div class="col-md-12 text-center">
                <h3 class="section-title no-padding-bottom">OKULUMUZDAN HABERLER</h3>
            </div>
        </div>
        <div class="container">
            <div class="row blog-masonry blog-masonry-3col no-transition" style="position: relative; height: 2955.86px;">
                <asp:Repeater runat="server" ID="rptNews">
                    <ItemTemplate>
                        <!-- post item -->
                        <div class="col-md-4 col-sm-6 col-xs-6 blog-listing" style="position: absolute; left: 0px; top: 0px;">
                            <div class="blog-image">
                                <a href='<%#Eval("Link") %>'>
                                    <img src='<%#Eval("ImageUrl").ToString().Substring(1) %>' alt=""></a>
                            </div>
                            <div class="blog-details">
                                <div class="blog-date">Yazar <%#Eval("NameSurname") %> | 02 January 2015</div>
                                <div class="blog-title"><a href='<%#Eval("Link") %>'><%#Eval("Header") %></a></div>
                                <div class="blog-short-description"><a href='<%#Eval("Link") %>'><%#Eval("ShortArticle") %></a></div>
                            </div>
                        </div>
                        <!-- end post item -->
                    </ItemTemplate>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <a href="/Haberler" class="btn highlight-button-black-border margin-four no-margin-bottom no-margin-lr btn-small">Tümünü Görüntüle</a>
                </div>
            </div>
        </div>
    </section>

    <section class="wow animated bg-gray" style="visibility: visible;">
        <div class="container mb-20">
            <div class="col-md-12 text-center">
                <h3 class="section-title no-padding-bottom">ETKİNLİKLER</h3>
            </div>
        </div>
        <div class="container">
            <div class="row blog-masonry blog-masonry-3col no-transition" style="position: relative; height: 2955.86px;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <a href="/Etkinlikler" class="btn highlight-button-black-border margin-four no-margin-bottom no-margin-lr btn-small">Tümünü Görüntüle</a>
                </div>
            </div>
        </div>
    </section>
