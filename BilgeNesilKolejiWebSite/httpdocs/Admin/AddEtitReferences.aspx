<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="AddEtitReferences.aspx.cs" Inherits="Admin_AddEtitReferences" %>
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-items">
                                <a href="#default-tab-2" data-toggle="tab" class="nav-link">
                                    ...
                                    <span class="d-sm-block d-none">İngilizce</span>
                                </a>
                            </li>
                        </ul>
                        <!-- end nav-tabs -->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="default-tab-2">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <asp:TextBox runat="server" ID="txtDescriptionEn" TextMode="MultiLine" CssClass="form-control" ClientIDMode="Static"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <!-- end tab-pane -->
