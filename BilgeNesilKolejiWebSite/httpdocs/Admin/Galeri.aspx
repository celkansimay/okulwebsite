<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Galeri.aspx.cs" Inherits="Admin_Galeri" ValidateRequest="false" %>
        ...
        <div class="col-md-12 ui-sortable">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Fotoğraf Galerisi
                    </h4>
                </div>
                <div class="panel-body">
                    <div id="data-table_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        <div class="row">
                            <div class="col-sm-12">
                                <asp:Repeater runat="server" ID="rptGallery" ClientIDMode="Static">
                                    <HeaderTemplate>
                                                ...
                                                <div class="btn-group m-r-5 m-b-5">
                                                    ...
                                                    <ul class="dropdown-menu pull-left">
                                                        <li><a href='FotoğrafGüncelle-<%#Eval("Id") %>' class="btn-xs" style="font-size: 14px;"><i class="fa fa-pencil-alt"></i>&nbsp;Düzenle</a>
                                                            <a href='GaleriDetay-<%#Eval("Id") %>' class="btn-xs" style="font-size: 14px;"><i class="fa fa-pencil-alt"></i>&nbsp;Fotoğraflar</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                            <td class=" "><%# Eval("Header") %></td>
                                            <td class=" "><%# Eval("Description") %></td>
                                            <td class=" "><%# DateTime.Parse(Eval("InsertDate").ToString()).ToString("yyyy/MM/dd") %></td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        </tbody>
