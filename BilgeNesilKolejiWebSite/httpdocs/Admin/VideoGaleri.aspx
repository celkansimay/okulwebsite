<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="VideoGaleri.aspx.cs" Inherits="Admin_VideoGaleri" ValidateRequest="false" %>
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <div class="panel-body">
                    <div id="data-table_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        <div class="row">
                            <div class="col-sm-12">
                                <asp:Repeater runat="server" ID="rptVideo" ClientIDMode="Static">
                                    <HeaderTemplate>
                                            ...
                                            <td class=" ">
                                                <div class="btn-group m-r-5 m-b-5">
                                                    ...
                                                    <ul class="dropdown-menu pull-left">
                                                        <li><a href='FotoğrafGüncelle-<%#Eval("Id") %>' class="btn-xs" style="font-size: 14px;"><i class="fa fa-pencil-alt"></i>&nbsp;Düzenle</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                            <td class=" "><%# Eval("Header") %></td>
                                            <td class=" " title='<%#ClearHtml(Eval("Url").ToString()) %>'><%# Eval("Url").ToString().Length > 100 ?  ClearHtml(Eval("Url").ToString().Substring(0,100)) + "..." : ClearHtml(Eval("Url").ToString()) %></td>
