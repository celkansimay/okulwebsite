<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="References.aspx.cs" Inherits="Admin_References" %>
        ...
        <div class="col-md-12 ui-sortable">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Referanslar
                    </h4>
                </div>
                <div class="panel-body">
                    <div id="data-table_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        <div class="row">
                            <div class="col-sm-12">
                                <asp:Repeater runat="server" ID="rptReferences" ClientIDMode="Static" OnItemCommand="rptReferences_ItemCommand" OnItemDataBound="rptReferences_ItemDataBound">
                                    <HeaderTemplate>
                                        <table class="table table-striped table-bordered dataTable no-footer dtr-inline" id="savedReportsTable" >
                                            <thead>
                                                <tr class="headings">
                                                    ...
                                                    <th class="column-title">Görsel</th>
                                    ...
                                    <ItemTemplate>
                                        <tr class="even pointer">
                                            <td class=" ">
                                                <div class="btn-group m-r-5 m-b-5">
                                                    ...
                                                    <ul class="dropdown-menu pull-left">
                                                        <li><a href='ReferansGüncelle-<%#Eval("Id") %>' class="btn-xs" style="font-size: 14px;"><i class="fa fa-pencil-alt"></i>&nbsp;Düzenle</a></li>
                                                        <li><asp:LinkButton runat="server" ID="btnDelete" CommandName="DeleteRow" CommandArgument='<%#Eval("Id") %>'><i class="fa fa-times"></i>&nbsp;Sil</asp:LinkButton></li>
                                                    </ul>
                                                </div>
                                            </td>
                                            <td class=" ">
                                                <asp:LinkButton runat="server" ID="btnDown" CommandName="ReferencesDown" CommandArgument='<%#Eval("Id") %>'><i class="fa fa-chevron-circle-down"></i></asp:LinkButton>
                                                <%# Eval("Rank") %>
                                                <asp:LinkButton runat="server" ID="btnUp" CommandName="ReferencesUp" CommandArgument='<%#Eval("Id") %>'><i class="fa fa-chevron-circle-up"></i></asp:LinkButton></td>
                                            <td class=" "><img src='<%# Eval("LogoUrl") %>' runat="server" height="40" /></td>
                                            ...
                                            <td class=" " title='<%#ClearHtml(Eval("DescriptionEn").ToString()) %>'><%# Eval("DescriptionEn").ToString().Length > 100 ?  ClearHtml(Eval("DescriptionEn").ToString().Substring(0,100)) + "..." : ClearHtml(Eval("DescriptionEn").ToString()) %></td>
