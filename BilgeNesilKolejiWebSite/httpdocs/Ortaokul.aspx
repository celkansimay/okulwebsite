<%@ Page Title="Ortaokul | Bilge Nesil Koleji" Language="C#" MasterPageFile="~/Bottom.master" AutoEventWireup="true" CodeFile="Ortaokul.aspx.cs" Inherits="Ortaokul" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="no-padding-top bg-white">
        <div class="container">
            <div class="row">
                <asp:Image runat="server" ID="ImageOrta" CssClass="img-responsive" />
