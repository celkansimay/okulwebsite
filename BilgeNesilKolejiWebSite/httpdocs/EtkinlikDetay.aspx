<%@ Page Title="Etkinlik Detay | Bilge Nesil Koleji" Language="C#" MasterPageFile="~/Bottom.master" AutoEventWireup="true" CodeFile="EtkinlikDetay.aspx.cs" Inherits="EtkinlikDetay" %>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-7 col-sm-12 wow fadeInUp animated" data-wow-duration="300ms" style="visibility: visible; animation-duration: 300ms; animation-name: fadeInUp;">
                    ...
                    <h1 class="black-text">
                        ...
                        <br />
                        <span class="blog-date">Yazar, <a><%=ActivityItem[0].NameSurname %></a>&nbsp;&nbsp;|&nbsp;&nbsp;<%= ActivityItem[0].ReleaseDate.ToString("dd/MM/yyyy") %></span>
                    </h1>
                    <!-- end page title -->
                    <!-- page title tagline -->
