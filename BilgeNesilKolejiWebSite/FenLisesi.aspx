<%@ Page Title="Fen Lisesi | Bilge Nesil Koleji" Language="C#" MasterPageFile="~/Bottom.master" AutoEventWireup="true" CodeFile="FenLisesi.aspx.cs" Inherits="FenLisesi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="no-padding-top bg-white">
        <div class="container">
            <div class="row">
                <asp:Image runat="server" ID="ImageFen" CssClass="img-responsive" />
