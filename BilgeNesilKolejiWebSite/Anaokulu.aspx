<%@ Page Title="Anaokulu | Bilge Nesil Koleji" Language="C#" MasterPageFile="~/Bottom.master" AutoEventWireup="true" CodeFile="Anaokulu.aspx.cs" Inherits="Anaokulu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-7 col-sm-12 wow fadeInUp animated" data-wow-duration="300ms" style="visibility: visible; animation-duration: 300ms; animation-name: fadeInUp;">
                    <!-- page title -->
                    <h1 class="black-text"><asp:Literal runat="server" ID="ltrHeader1"></asp:Literal></h1>
                    <!-- end page title -->
                    <!-- page title tagline -->
                ...
                <div class="col-lg-4 col-md-5 col-sm-12 breadcrumb text-uppercase sm-no-margin-top wow fadeInUp xs-display-none animated" data-wow-duration="600ms" style="visibility: visible; animation-duration: 600ms; animation-name: fadeInUp;">
                    ...
                    <ul>
                        ...
                        <li><a href="#"><asp:Literal runat="server" ID="ltrBreadHeader1"></asp:Literal></a></li>
    ...
    <section class="no-padding-top bg-white">
        <div class="container">
            <div class="row">
                <asp:Image runat="server" ID="ImageAna" CssClass="img-responsive" />
