<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="DemoForms.aspx.cs" Inherits="Admin_DemoForms" %>
                                ...
                                <asp:Repeater runat="server" ID="rptContents" ClientIDMode="Static">
                                    <HeaderTemplate>
                                        <table class="table table-striped table-bordered dataTable no-footer dtr-inline" id="savedReportsTable">
                                            <thead>
                                                <tr class="headings">
                                                    <th class="column-title">Şirket Adı</th>
                                    ...
                                    <ItemTemplate>
                                        <tr class="even pointer">
                                            ...
                                            <td class=" ">
                                                <a href='DemoFormDetay-<%#Eval("Id") %>' class="btn btn-primary btn-xs">Detay</a>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
