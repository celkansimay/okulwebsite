<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="SliderList.aspx.cs" Inherits="Admin_SliderList" %>
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <div id="data-table_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        <div class="row">
                            <div class="col-sm-12">
                                <asp:Repeater runat="server" ID="rptSliders" ClientIDMode="Static">
                                    <HeaderTemplate>
                                            ...
                                            <td class=" ">
                                                <div class="btn-group m-r-5 m-b-5">
                                                    ...
                                                    <ul class="dropdown-menu pull-left">
                                                        <li><a href='SliderGüncelle-<%#Eval("Id") %>' class="btn-xs" style="font-size: 14px;"><i class="fa fa-pencil-alt"></i>&nbsp;Düzenle</a></li>
                                                    </ul>
                                                </div>
                                            </td>
