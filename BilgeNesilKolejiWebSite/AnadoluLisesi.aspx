<%@ Page Title="Anadolu Lisesi | Bilge Nesil Koleji" Language="C#" MasterPageFile="~/Bottom.master" AutoEventWireup="true" CodeFile="AnadoluLisesi.aspx.cs" Inherits="AnadoluLisesi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="no-padding-top bg-white">
        <div class="container">
            <div class="row">
                <asp:Image runat="server" ID="ImageAnadolu" CssClass="img-responsive" />
