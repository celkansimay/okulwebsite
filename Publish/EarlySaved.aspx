<%@ page title="" language="C#" masterpagefile="~/Bottom.master" autoeventwireup="true" inherits="EarlySaved, App_Web_bln2rj34" %>
                ...
                <div class="col-md-7 col-sm-10 center-col">
                    <div class="register-content" visible="true">
                        ...
                        <div class="row m-b-15">
                            <div class="col-md-12">
                                <asp:DropDownList runat="server" ID="ddlClass" CssClass="form-control" AppendDataBoundItems="false">
