<%@ page title="Fotoğraf Galerisi | Bilge Nesil Koleji" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="FotoGaleri, App_Web_bln2rj34" %>
                ...
                <asp:Repeater runat="server" ID="rptPhotoGallery" OnItemDataBound="rptPhotoGallery_ItemDataBound">
                    <ItemTemplate>
                        <div class="col-md-4 col-sm-6">
                            <!-- photo item -->
                            <h3><a href='FotoGaleriDetay/<%#Eval("Id") %>'>
                                <%#Eval("Header") %>
                            </a></h3>
