<%@ page title="İletişim | Bilge Nesil Koleji" language="C#" masterpagefile="~/Bottom.master" autoeventwireup="true" inherits="Contact, App_Web_bln2rj34" %>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <p class="text-med text-uppercase letter-spacing-1 black-text font-weight-600">İletişim</p>
                            <p class="text-med">
