<%@ page title="" language="C#" masterpagefile="~/Admin/MasterPage.master" autoeventwireup="true" inherits="Admin_Activities, App_Web_jw0yzfwl" %>
        ...
        <div class="col-md-12 ui-sortable">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Etkinlik Yazıları
                    </h4>
                </div>
                <div class="panel-body">
                    <div id="data-table_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        <div class="row">
                            <div class="col-sm-12">
                                <asp:Repeater runat="server" ID="rptActivity" ClientIDMode="Static">
                                    <HeaderTemplate>
                                            ...
                                            <td class=" ">
                                                <div class="btn-group m-r-5 m-b-5">
                                                    ...
                                                    <ul class="dropdown-menu pull-left">
                                                        <li><a href='EtkinlikGüncelle-<%#Eval("Id") %>' class="btn-xs" style="font-size: 14px;"><i class="fa fa-pencil-alt"></i>&nbsp;Düzenle</a></li>
                                                    </ul>
                                                </div>
                                            </td>
