<%@ page title="" language="C#" masterpagefile="~/Admin/MasterPage.master" autoeventwireup="true" inherits="Admin_Users, App_Web_jw0yzfwl" %>
        ...
        <div class="col-md-12 ui-sortable">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Yöneticiler
                    </h4>
                </div>
                                        ...
                                        <table class="table table-striped table-bordered dataTable no-footer dtr-inline" id="savedReportsTable">
                                            <thead>
                                                <tr class="headings">
                                                    ...
                                                    <th class="column-title">Son Giriş Tarihi</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    </HeaderTemplate>
                                            ...
                                            <td class=" ">
                                                <div class="btn-group m-r-5 m-b-5">
                                                    ...
                                                    <ul class="dropdown-menu pull-left">
                                                        <li><a href='KullanıcıGüncelle-<%#Eval("Id") %>' class="btn-xs" style="font-size: 14px;"><i class="fa fa-pencil-alt"></i>&nbsp;Düzenle</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                            <td class=" "><%# Eval("NameSurname") %></td>
                                            <td class=" "><%# Eval("UserName") %></td>
                                            <td class=" "><%# Eval("LastLoginDate") != null ? DateTime.Parse(Eval("LastLoginDate").ToString()).ToString("dd/MM/yyyy HH:mm") : "Giriş yapılmadı" %></td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        </tbody>
