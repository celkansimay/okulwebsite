<%@ page title="" language="C#" masterpagefile="~/Admin/MasterPage.master" autoeventwireup="true" inherits="Admin_Products, App_Web_jw0yzfwl" %>
                                ...
                                <asp:Repeater runat="server" ID="rptProducts" ClientIDMode="Static">
                                    ...
                                    <ItemTemplate>
                                        <tr class="even pointer">
                                            ...
                                            <td class=" "><%# Eval("ProductNameEn") %></td>
