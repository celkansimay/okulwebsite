<%@ page title="" language="C#" masterpagefile="~/Admin/MasterPage.master" autoeventwireup="true" inherits="Admin_GaleriDetay, App_Web_jw0yzfwl" %>
                ...
                <div class="image col-lg-3">
                    ...
                    <div class="image-info">
                        ...
                        <div class="row">
                            ...
                            <%--<div class="col-lg-6">
                                <a href='SliderSettings.aspx?Id=<%#Eval("Id") %>' class="btn btn-block btn-primary btn-sm m-r-5">Güncelle</a>
                            </div>--%>
                        </div>
                    </div>
                </div>
